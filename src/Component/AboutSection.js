...
function AboutSection() {
  return (
    <div className="bg-gray-50 pt-10 lg:pt-2 ">
      <div className="lg:pt-0 grid grid-cols-1 lg:grid-cols-2 justify-between items-center">
        ...
        />
        <div className="px-6 sm:px-10 md:px-14 lg:mt-0 2xl:px-36 flex flex-col items-center">
          <p className="mt-5 lg:mt-0 text-lg md:text-2xl lg:text-3xl font-semibold text-greeen">
            About Our Store
          </p>
      ...
      <div className="lg:pt-0 grid grid-cols-1 lg:grid-cols-2 justify-between items-center">
        <div className="px-6 sm:px-10 md:px-14  2xl:px-36 flex flex-col items-center">
          <p className="mb-5 lg:mb-0 md:text-lg  flex leading-8 mt-5 lg:px-10 text-gray-800">
